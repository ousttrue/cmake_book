...
const sidebars: SidebarsConfig = {
  ...
  tutorialSidebar: [
    ...
    "commandline",
    {
      ...
      items: [
        ...
        "targets/custom_target",
        {
          type: "category",
          label: "Properties",
          link: { type: "doc", id: "targets/properties" },
          items: [
            "targets/source",
            "targets/compile",
            "targets/link",
    ...
    },
    {
      type: "category",
      label: "pixi",
      link: { type: "doc", id: "pixi/index" },
      items: [
        {
          type: "category",
          label: "QT",
          items: ["pixi/qt/qt5", "pixi/qt/qt6"],
        },
        {
          type: "category",
          label: "ROS2",
          link: { type: "doc", id: "pixi/ros2/index" },
          items: ["pixi/ros2/colcon", "pixi/ros2/ros_api"],
        },
      ],
    },
  ],
